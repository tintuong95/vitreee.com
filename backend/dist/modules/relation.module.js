...
exports.RelationModule = RelationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([relation_1.Relation])],
        controllers: [relation_controller_1.RelationController],
        providers: [relation_provider_1.RelationProvider],
    })
], RelationModule);
